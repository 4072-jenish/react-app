        ...
        <Navbar key={expand} expand={expand} >
          <Container  className="header">
            ...
            <ul className="list-unstyled d-flex gap-5 justify-content-between align-items-center m-0 navbar" >
              ...
              <NavDropdown.Divider />
              <NavDropdown.Item href="#action/3.3"><Link to={"/Service"}>Our Services</Link>  </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="#action/3.3">Our Team</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="#action/3.3"><Link to={"/Testimonials"}>Testimonials</Link></NavDropdown.Item>
              <NavDropdown.Divider />
                ...
                <NavDropdown title= {
                  ...
                  <div className="shop_page d-flex justify-content-between gap-5 align-item-center" style={{width: "1050px"}}>
                      ...
                      <ul className="list-unstyled w-50">
                        ...
                        <li><NavDropdown.Item href="#action/3.3"><Link to={"/Shop"} >Shop Details 01 </Link></NavDropdown.Item></li>
                        <NavDropdown.Divider />
